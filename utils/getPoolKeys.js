...
class PoolKeys {
    static fetchMarketId(connection, baseMint, quoteMint, commitment) {
        return __awaiter(this, void 0, void 0, function* () {
            const accounts = yield connection.getProgramAccounts(new web3_js_1.PublicKey('srmqPvymJeFKQ4zGQed1GFppgkRHL9kaELCbyksJtPX'), {
                commitment,
                filters: [
    ...
    static fetchMarketInfo(marketId) {
        return __awaiter(this, void 0, void 0, function* () {
            const marketAccountInfo = yield this.connection.getAccountInfo(marketId, "processed");
    ...
    static generateV4PoolInfo(baseMint, baseDecimals, quoteMint, marketID) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    static fetchPoolKeyInfo(baseMint, quoteMint) {
        return __awaiter(this, void 0, void 0, function* () {
            const marketId = yield this.fetchMarketId(this.connection, baseMint, quoteMint, 'processed');
            const marketInfo = yield this.fetchMarketInfo(marketId);
            const baseMintInfo = yield this.connection.getParsedAccountInfo(baseMint, "processed");
            const baseDecimals = baseMintInfo.value.data.parsed.info.decimals;
            const V4PoolInfo = yield this.generateV4PoolInfo(baseMint, baseDecimals, quoteMint, marketId);
            const lpMintInfo = yield this.connection.getParsedAccountInfo(V4PoolInfo.poolInfo.lpMint, "processed");
            return {
...
PoolKeys.connection = new web3_js_1.Connection(constants_1.RPC_ENDPOINT, {
