...
function bull_dozer(txs, keypair) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const jitoKey = web3_js_1.Keypair.fromSecretKey(bs58_1.default.decode(constants_1.JITO_AUTH_KEYPAIR));
            const search = (0, searcher_1.searcherClient)(constants_1.BLOCKENGINE_URL, jitoKey);
            console.log("🚀  BLOCKENGINE_URL:", constants_1.BLOCKENGINE_URL);
